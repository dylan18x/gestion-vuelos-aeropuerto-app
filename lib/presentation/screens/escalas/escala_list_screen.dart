// lib/presentation/screens/escalas/escala_list_screen.dart
...
/// No existe un endpoint "todas las escalas": se consulta por vuelo.
/// Esta pantalla lista los vuelos; al tocar uno, ves sus escalas.
class EscalaListScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('Escalas por vuelo')),
                  ...
                  return Container(
                    ...
                    child: ListTile(
                      ...
                      leading: Container(
                        ...
                        child: const Icon(Icons.alt_route_rounded, color: AppColors.accent, size: 22),
                      ),
                      title: Text(
                        vuelo.codigoVuelo,
                      ...
                      onTap: () => context.push('/escalas/${vuelo.id}'),
                    ),
                  );
                },
              ),
